$(document).ready(function(){
    ...
    $('body').on('click', '#logingo', function() {
        ...
        if(req) {
            ...
            var json = jsonreturn('/utopiaeloom3/admin/main/loginData',data);
            if(json.return == true) {
                location.href = '/utopiaeloom3/admin/event/list';
            }
            else {
    ...
    $('body').on('click', '#logingo2', function() {
        ...
        if(req) {
            ...
            var json = jsonreturn('/utopiaeloom3/admin/main/loginData',data);
            if(json.return == true) {
                location.href = '/utopiaeloom3/admin/event2/list';
            }
            else {
                alert("아이디 비밀번호가 일치하지 않습니다");
            }
            ...
            $('body').on('click', '#eventgo, #eventedit', function() {
                ...
                if(check) {
                    ...
                    if($(this).attr('id') == "eventgo"){
                        var json = jsonreturn('/utopiaeloom3/admin/event/addData',data);
                        if(json.return == true) {
                            alert("등록되었습니다");
                            location.href = "/utopiaeloom3/admin/event/list";
                        }
                        ...
                        var json = jsonreturn('/utopiaeloom3/admin/event/editData',data);
                        if(json.return == true) {
                            alert("수정되었습니다");
                            location.href = "/utopiaeloom3/admin/event/list";
                        }
        ...
        this.event2 = function() {
            ...
            $('body').on('click', '#eventgo2, #eventedit2', function() {
                ...
                if(check) {
                    ...
                    var data = new FormData(form);
                    if($(this).attr('id') == "eventgo"){
                        var json = jsonreturn('/utopiaeloom3/admin/event2/addData',data);
                        if(json.return == true) {
                            alert("등록되었습니다");
                            location.href = "/utopiaeloom3/admin/event2/list";
                        }
                        ...
                        var json = jsonreturn('/utopiaeloom3/admin/event2/editData',data);
                        if(json.return == true) {
                            alert("수정되었습니다");
                            location.href = "/utopiaeloom3/admin/event2/list";
                        }
