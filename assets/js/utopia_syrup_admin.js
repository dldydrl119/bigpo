$(document).ready(function(){
    ...
    $('body').on('click', '#logingo', function() {
        ...
        if(req) {
            ...
            var json = jsonreturn('/utopia/syrup/admin/main/loginData',data);
            if(json.return == true) {
                location.href = '/utopia/syrup/admin/event/list';
            }
            else {
            ...
            $('body').on('click', '#eventgo, #eventedit', function() {
                ...
                if(check) {
                    ...
                    if($(this).attr('id') == "eventgo"){
                        var json = jsonreturn('/utopia/syrup/admin/event/addData',data);
                        if(json.return == true) {
                            alert("등록되었습니다");
                            location.href = "/utopia/syrup/admin/event/list";
                        }
                        ...
                        var json = jsonreturn('/utopia/syrup/admin/event/editData',data);
                        if(json.return == true) {
                            alert("수정되었습니다");
                            location.href = "/utopia/syrup/admin/event/list";
                        }
