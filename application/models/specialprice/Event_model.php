...
//        $this->load->library('session');
    ...
    public function eventListData($page = 1)
    {
        ...
        $sql="SELECT @rownum:=@rownum+1 num, idx, name,memo,hope,call2,note, reg_date 
        from specialprice_event, (SELECT @rownum:= {$offset}) TMP 
        ORDER BY idxs DESC limit {$limit} offset {$offset}";
