...
<script src="<?= base_url('assets/js/utopia_02_sbj_admin.js') ?>"></script>
            ...
            <div class="animate form login_form">
                <section class="login_content">
                    <form action="" onsubmit="return false;">
                        ...
                        <div>
                            <input type="text" class="form-control log req" name="id" placeholder="아이디" required="required"></input>
                        </div>
                        <div>
                            <input type="password" class="form-control log req" name="pass" placeholder="비밀번호" required="required"></input>
                        </div>
                        <div>
                        ...
                        <div class="separator">
                            <div>
                                <p>Copyright © 교원라이프. All rights reserved.</p>
                            </div>
                        </div>
                    </form>
                </section>
