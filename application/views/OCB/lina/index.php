...
<body>
			...
			<div class="col-sm-offset-3 col-sm-6 col-xs-12">
				<div class="video-bg add_bg_01">
					<div class="video-container">
						<iframe width="100%" src="https://www.youtube.com/embed/8xQbJaki-Uw" frameborder="0"></iframe>
		...
		<div class="container">
			<div class="col-sm-offset-3 col-sm-6 col-xs-12">
				<div class="get_area_m" id="list" style="margin: 20px;">
					<button id="button" class="sbj_01" onclick="location.href='tel:1566-8236'">
		...
		<div class="container">
			<div class="col-sm-offset-3 col-sm-6 col-xs-12">
				<div style="margin: 20px;">
					<button id="button" class="lina" onclick="location.href='tel:1566-8236'">
	...
	<footer>
		<div class="container">
			<div class="col-sm-offset-3 col-sm-6 col-xs-12">
				<img src="/assets/images/OCB/lina/footer.png" alt="푸터이미지">
			</div>
		</div>
	</footer>
</body>
