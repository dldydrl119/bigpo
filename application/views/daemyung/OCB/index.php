...
<body>
	<div class="sect_1">
		<div class="container">
			<div class="col-sm-offset-3 col-sm-6 col-xs-12">
				<img src="/assets/images/daemyung/OCB/main.jpg" alt="메인이미지">
			</div>
		</div>
	</div>
	<div class="sect_2">
			...
			<div class="col-sm-offset-3 col-sm-6 col-xs-12">
				<div class="video-bg add_bg_01">
					<div class="video-container">
						<iframe width="100%" src="https://www.youtube.com/embed/Q-9TZ6982zI" frameborder="0"></iframe>
		...
		<div class="container">
			<div class="col-sm-offset-3 col-sm-6 col-xs-12">
				<div class="get_area_m" >
					<button id="button" class="daemyung_01" onclick="location.href='tel:080-645-5000'">
		...
		<div class="container">
			<div class="col-sm-offset-3 col-sm-6 col-xs-12">
				<div id="list" style="margin: 20px;">
					<button id="button" class="daemyung" onclick="location.href='tel:080-645-5000'">
		...
		<div id="pop">
			<article>
				...
				<div class="infoDetail">
					...
					<p><strong>[ 080-645-5000 ]</strong>으로 지금바로 전화주세요.</p><br>
	...
	<footer>
		<div class="container">
			<div class="col-sm-offset-3 col-sm-6 col-xs-12">
				<img src="/assets/images/daemyung/OCB/footer.jpg" alt="푸터이미지">
			</div>
		</div>
