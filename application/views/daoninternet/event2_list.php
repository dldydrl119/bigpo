        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    ...
                    <?}?>
                    <button type="button" id="idxgo" class="btn btn-primary" data-url="/daoninternet/admin/event2/order" data-count="/daoninternet/admin/event2/count" data-page="<?= $page ?>">순서 저장하기</button></a>
                    <div class="clearfix"></div>
                </div>
                <div class="x_content">
...
<script>
    $('body').on('click', '.adminedit', function() {
        ...
        location.href = '/daoninternet/admin/event2/edit/' + idx;
    });
    $('body').on('click', '.admindel', function() {
        var con = confirm("정말 삭제하시겠습니까?");
        if (con) {
            var idx = $(this).parent().parent().attr('data-idx');
            var result = jsonreturn('/daoninternet/admin/event2/datadel/' + idx);
