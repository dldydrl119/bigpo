                    ...
                    <div class="x_content">
                        ...
                        <form class="form-horizontal form-label-left">
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="number" class="form-control col-md-7 col-xs-12 req" name="number" value="<?= isset($data->number) ? $data->number : '' ?>" required="required">
                                </div>
                            </div>

                            <div class="item form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="memo"> 메모 <span class="required">*</span></label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <textarea style="width: 100%;" id="memo" class="form-control col-md-7 col-xs-12 req" name="memo" required="required"><?= isset($data->memo) ? $data->memo : '' ?></textarea>
                                </div>
                            </div>

                            <div class="item form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="gender"> 승인 여부 <span class="required">*</span></label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="gender" class="form-control col-md-7 col-xs-12 req" name="gender" value="<?= isset($data->gender) ? $data->gender : '' ?>" required="required">
                                </div>
                            </div>
                            ...
                            <? if ($editor_func) : ?>
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="image"> 메모 <span class="required">*</span></label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <textarea style="width: 100%;" id="content" name="content" class="req" required="required"><?= isset($data->content) ? $data->content : '' ?></textarea>
                                    </div>
                                </div>
                                <!--smart에디터 이미지업로드용-->
