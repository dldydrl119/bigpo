...
<script src="<?= base_url('assets/js/daoninternet_admin.js') ?>"></script>
            ...
            <div class="animate form login_form">
                <section class="login_content">
                    <form action="" onsubmit="return false;">
                        <h1><img src="/assets/images/home/logo.png" class="login_symbol" alt=""></h1>
                        <div>
                        ...
                        <div>
                            <a id="logingo2" class="btn btn-default submit">Log in</a>
                        ...
                        <div class="separator">
                            <div>
                                <p>Copyright © 빅포. All rights reserved.</p>
                            </div>
                        </div>
                    </form>
                </section>
