...
<body>
	<div class="sect_1">
		<div class="container">
			<div class="col-sm-offset-3 col-sm-6 col-xs-12">
				<img src="/assets/images/sbj_02/main1.jpg?<?=time();?>" alt="메인이미지">
			</div>
		</div>
	</div>
	<div class="sect_2">
			...
			<div class="col-sm-offset-3 col-sm-6 col-xs-12">
				<div class="video-bg bg_02">
					<div class="video-container">
						<iframe width="100%" src="https://www.youtube.com/embed/abDq2NFgsyg" frameborder="0" allowfullscreen="true"></iframe>
	...
	<div class="sect_3">
		<div class="container">
			<div class="col-sm-offset-3 col-sm-6 col-xs-12">
				<button id="DB_OCB01" class="sbj_02"style="margin: 10px;" onclick="location.href='tel:0800199900'">상담 예약하기<br>
	...
	<footer>
		<div class="container">
			<div class="col-sm-offset-3 col-sm-6 col-xs-12">
				<img src="/assets/images/sbj_02/footer1.jpg" alt="푸터이미지">
			</div>
		</div>
	</footer>
