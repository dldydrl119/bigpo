...
<script type="text/javascript">
	...
	for (var word in mobileKeyWords) {
		if (navigator.userAgent.match(mobileKeyWords[word]) != null) {
			location.href = "http://bigpo.co.kr/cuckoo/promotion_5_m";
			break;
		}
	}
</script>
...
<body>
	<div class="sect_1">
		<div class="container">
			<div class="col-sm-offset-3 col-sm-6 col-xs-12">
				<img src="/assets/images/sbj_01/main.webp" alt="메인이미지">
			</div>
		</div>
	</div>
	<div class="sect_2">
		<div class="container">
			<div class="col-sm-offset-3 col-sm-6 col-xs-12">
				<div class="video-bg bg_01">
					<div class="video-container">
						<iframe width="100%" src="https://www.youtube.com/embed/4JKW1S4AoaI?autoplay=1&mute=1" frameborder="0"></iframe>
					</div>
				</div>
			</div>
		</div>
	...
	<div class="sect_3">
		<div class="container">
			<div class="col-sm-offset-3 col-sm-6 col-xs-12">
				<button id="AIA_OCB01" class="sbj_01" onclick="location.href='tel:080-855-2900'">상담 예약하기<br>
	...
	<footer>
		<div class="container">
			<div class="col-sm-offset-3 col-sm-6 col-xs-12">
				<img src="/assets/images/sbj_01/footer.webp" alt="푸터이미지">
			</div>
		</div>
	</footer>
