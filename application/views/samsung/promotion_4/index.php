...
<body>
	<div class="sect_1">
		<div class="container">
			<div class="cuckoo" class="col-sm-offset-3 col-sm-6 col-xs-12">
				<img class="W_img" src="/assets/images/cuckoo/pet/cuckoo_pet1.jpg" alt="메인이미지">
				<img class="M_img" src="/assets/images/cuckoo/pet/cuckoo_pet1_m.png" alt="메인이미지">
			</div>
		</div>
	</div>
	<div class="sect_2">
		<div class="container" style="background-color: #f8ebce;">
			<div class="col-sm-offset-3 col-sm-6 col-xs-12">
				<div class="video-bg bg_cuckoo">
					<div class="video-container">
						<iframe width="100%" src="https://www.youtube.com/embed/uDxdhmnO2yk" frameborder="0"></iframe>
				</div>
			</div>
		</div>
	</div>
	<div class="sect_1">
		<div class="container">
			<div class="cuckoo" class="col-sm-offset-3 col-sm-6 col-xs-12">
				<img class="W_img" src="/assets/images/cuckoo/pet/cuckoo_pet2.jpg" alt="메인이미지">
				<img class="M_img" src="/assets/images/cuckoo/pet/cuckoo_pet2_m.png" alt="메인이미지">
			</div>
		</div>
	</div>
		...
		<div class="sect_3">
			<div class="container">
				<div class="sang_button" id="contents">
					...
					<button id="AIA_OCB01" class="sbj_cuckoo" onclick="location.href='tel:080-273-3000'">
	...
	<div id="pop">
		<article>
			...
			<div class="infoDetail">
				...
				<p><strong>[ 080-273-3000 ]</strong>으로 지금바로 전화주세요.</p><br>
	...
	<div class="floating">
			<div><a href="#list"><img src="/assets/images/cuckoo/pet/side.png"></a> </div>
		</div>

	<footer>
		<div class="container">
			<div class="col-sm-offset-3 col-sm-6 col-xs-12" style="width:100%;margin-left:0px;">
				<img class="W_img" src="/assets/images/cuckoo/pet/cuckoo_pet3.jpg" alt="푸터이미지">
				<img class="M_img" src="/assets/images/cuckoo/pet/cuckoo_pet3_m.png" alt="메인이미지">
			</div>
		</div>
	</footer>
