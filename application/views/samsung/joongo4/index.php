...
<body>
	<div class="sect_1">
		<div class="container">
			<div class="col-sm-offset-3 col-sm-6 col-xs-12">
				<img src="/assets/images/samsung/joongo4/main.jpg" alt="메인이미지">
			</div>
		</div>
	</div>
	<div class="sect_2">
			...
			<div class="col-sm-offset-3 col-sm-6 col-xs-12">
				<div class="video-bg_samsung tmon2 add_bg_01">
					<div class="video-container">
						<iframe width="100%" src="https://www.youtube.com/embed/LMO_io5Ljgg" frameborder="0"></iframe>
					</div>
				</div>
			</div>
		</div>
	...
	<div class="get_area_m" >
		<div class="sect_3 web1">
			<div class="container">
				<div class="col-sm-offset-3 col-sm-6 col-xs-12">
					<div class="sang_button">
						<button id="button" class="sbj_cuckoo_gong" onclick="location.href='tel: 080-615-3600'">                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            
			...
			<div class="container">
				<div class="col-sm-offset-3 col-sm-6 col-xs-12" class="sang_button" id="contents">
					<div class="get_area1" id="list" style="margin: 20px 0px;">
						<button id="button" class="tmon2" onclick="location.href='tel: 080-615-3600'">
	...
	<div id="pop">
		<article>
			...
			<div class="infoDetail">
				...
				<p><strong>[ 080-615-3600 ]</strong>으로 지금바로 전화주세요.</p><br>
	...
	<footer>
		<div class="container">
			<div class="col-sm-offset-3 col-sm-6 col-xs-12">
				<br><br>
				<img src="/assets/images/samsung/joongo4/footer.jpg" alt="푸터이미지">
