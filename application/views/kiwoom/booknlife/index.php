			...
			<div class="col-sm-offset-3 col-sm-6 col-xs-12">
				<div class="video-bg add_bg_01">
					<div class="video-container">
						<iframe width="100%" src="https://www.youtube.com/embed/5x1Ee0B_PeM" frameborder="0"></iframe>
					</div>
				</div>
			</div>
		</div>
	...
	<div class="get_area_m" >
		<div class="sect_3 web1">
			<div class="container">
				<div class="col-sm-offset-3 col-sm-6 col-xs-12">
					<div class="sang_button">
						<button id="button" class="sbj_kiwoom" onclick="location.href='tel:080-206-5050'">
			...
			<div class="container">
				<div class="col-sm-offset-3 col-sm-6 col-xs-12" class="sang_button" id="contents">
					<div class="get_area1" id="list" style="margin: 20px 0px;">
						<button id="button" class="kiwoom" onclick="location.href='tel:080-206-5050'">
	...
	<div id="pop">
		<article>
			...
			<div class="infoDetail">
				...
				<p><strong>[ 080-206-5050 ]</strong>으로 지금바로 전화주세요.</p><br>
