			...
			<div class="col-sm-offset-3 col-sm-6 col-xs-12">
				<div class="video-bgcuckoo4 add_bg_01">
					<div class="video-container">
						<iframe width="100%" src="https://www.youtube.com/embed/6nMthOIJF28" frameborder="0"></iframe>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="container">
			<div class="col-sm-offset-3 col-sm-6 col-xs-12">
				<div class="get_area_m">
					<button id="button" class="cuckoo4_01" onclick="location.href='tel:080-959-0119'">
		...
		<div class="container">
			<div class="col-sm-offset-3 col-sm-6 col-xs-12">
				<div id="list" style="margin: 20px;">
					<button id="button" class="cuckoo4" onclick="location.href='tel:080-959-0119'">
		...
		<div id="pop">
			<article>
				...
				<div class="infoDetail">
					...
					<p><strong>[ 080-959-0119 ]</strong>으로 지금바로 전화주세요.</p><br>
