...
<body>
	<div class="sect_1">
		<div class="container">
			<div class="col-sm-offset-3 col-sm-6 col-xs-12">
				<img src="/assets/images/aia/OCB/OCB_main.jpg" alt="메인이미지">
			</div>
		</div>
	</div>
	<div class="sect_2">
		...
		<div id="pop">
			<article>
				...
				<div class="infoDetail">
					...
					<p><strong>[ 080-406-9900 ]</strong>으로 지금바로 전화주세요.</p><br>
	...
	<footer>
		<div class="container">
			<div class="col-sm-offset-3 col-sm-6 col-xs-12">
				<img src="/assets/images/aia/OCB/OCB_footer.jpg" alt="푸터이미지">
			</div>
		</div>
