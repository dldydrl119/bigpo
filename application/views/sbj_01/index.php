...
<body>
	<div class="sect_1">
		<div class="container">
			<div class="col-sm-offset-3 col-sm-6 col-xs-12">
				<img src="/assets/images/sbj_01/main.png" alt="메인이미지">
			</div>
		</div>
	</div>
	<div class="sect_2">
		<div class="container">
			<div class="col-sm-offset-3 col-sm-6 col-xs-12">
				<div class="video-bg add_bg_01">
					...
					<div id="text">
						<img id="img" src="/assets/images/addward/addward1_play.png" alt="동영상이미지">
						<p>위 영상 시청 후</p>
						<p>상담 예약 버튼을 클릭하여 상담 예약을 남기면 끝!</p>
					</div>
				</div>
			</div>
		</div>
	...
	<div id="pop">
		<article>
			...
			<div class="infoDetail">
				...
				<p><strong>[ 080-868-0200 ]</strong>으로 지금바로 전화주세요.</p><br>
	...
	<footer>
		<div class="container">
			<div class="col-sm-offset-3 col-sm-6 col-xs-12">
				<img src="/assets/images/sbj_01/footer.png" alt="푸터이미지">
			</div>
		</div>
	</footer>
</body>
