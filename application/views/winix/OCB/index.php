	...
	<div class="sect_1">
		<div class="container">
			<div class="cuckoo" class="col-sm-offset-3 col-sm-6 col-xs-12">
				<img class="W_img" src="/assets/images/winix/OCB/main.jpg" alt="메인이미지">
				<img class="M_img" src="/assets/images/winix/OCB/main.jpg" alt="메인이미지">
			</div>
		</div>
	</div>
	<div class="sect_2">
		...
		<div class="sect_1">
			<div class="container">
				<div class="cuckoo" class="col-sm-offset-3 col-sm-6 col-xs-12">
					<img class="W_img" src="/assets/images/winix/OCB/main2.jpg" alt="메인이미지">
					<img class="M_img" src="/assets/images/winix/OCB/main2.jpg" alt="메인이미지">
				</div>
			</div>
		</div>
		...
		<footer>
			<div class="container">
				<div class="col-sm-offset-3 col-sm-6 col-xs-12" style="width:100%;margin-left:0px;">
					<img class="W_img" src="/assets/images/winix/OCB/footer.jpg" alt="푸터이미지">
					<img class="M_img" src="/assets/images/winix/OCB/footer.jpg" alt="메인이미지">
				</div>
			</div>
		</footer>
