	...
	<div class="sect_1">
		<div class="container">
			<div class="cuckoo" class="col-sm-offset-3 col-sm-6 col-xs-12">
				<img class="W_img" src="/assets/images/winix/winix_1.jpg" alt="메인이미지">
				<img class="M_img" src="/assets/images/winix/winix_1.jpg" alt="메인이미지">
			</div>
		</div>
	</div>
	<div class="sect_2">
		...
		<div class="sect_1">
			<div class="container">
				<div class="cuckoo" class="col-sm-offset-3 col-sm-6 col-xs-12">
					<img class="W_img" src="/assets/images/winix/winix_2.jpg" alt="메인이미지">
					<img class="M_img" src="/assets/images/winix/winix_2.jpg" alt="메인이미지">
				</div>
			</div>
		</div>
				...
				<div class="container">
					<div class="sang_button" id="contents">
						<div class="get_area1" id="list">
							<button id="AIA_OCB01" class="sbj_winix" onclick="location.href='tel:080-601-5000'">
		...
		<div id="pop">
			<article>
				...
				<div class="infoDetail">
					...
					<p><strong>[ 080-601-5000 ]</strong>으로 지금바로 전화주세요.</p><br>
		...
		<footer>
			<div class="container">
				<div class="col-sm-offset-3 col-sm-6 col-xs-12" style="width:100%;margin-left:0px;">
					<img class="W_img" src="/assets/images/winix/winix_3.jpg" alt="푸터이미지">
					<img class="M_img" src="/assets/images/winix/winix_3.jpg" alt="메인이미지">
				</div>
			</div>
		</footer>
