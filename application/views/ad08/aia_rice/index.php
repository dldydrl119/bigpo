...
<body>
	<div class="sect_1">
		<div class="container">
			<div class="col-sm-offset-3 col-sm-6 col-xs-12">
				<img src="/assets/images/ad08/aia_rice/main.jpg" alt="메인이미지">
			</div>
		</div>
	</div>
	<div class="sect_2">
				...
				<div class="col-sm-offset-3 col-sm-6 col-xs-12">
					<div class="sang_button">
						<button id="button" class="aia_rice_m" onclick="location.href='tel:080-859-5050'">
							<p style="color: white; font-size :12px;">평균 예약 소요시간 30초!</p>상담예약 하러가기<br>
					</div>
					</button>
				</div>
			</div>
				...
				<div class="col-sm-offset-3 col-sm-6 col-xs-12" class="sang_button" id="contents">
					<div class="get_area1" id="list" style="padding: 20px 0px; background-color:#f9f9f9">
						<button id="button" class="aia_rice" onclick="location.href='tel:080-859-5050'">
							<p>평균 예약 소요시간 30초!</p>상담예약 하러가기<br>
						</button>
					</div>
				</div>
			</div>
	...
	<div id="pop">
		<article>
			...
			<div class="infoDetail">
				...
				<p><strong>[ 080-859-5050 ]</strong>으로 지금바로 전화주세요.</p><br>
	...
	<footer>
		<div class="container">
			<div class="col-sm-offset-3 col-sm-6 col-xs-12">
				<img src="/assets/images/ad08/aia_rice/footer.jpg" alt="푸터이미지">
