        ...
        <div class="col-md-3 left_col">
            <div class="left_col scroll-view">
                <div class="navbar nav_title" style="border: 0;">
                    <a href="#" class="site_title"><img src="/assets/images/symbol.png" alt=""> <span>라이프앤플러스</span></a>
                </div>
                        ...
                        <ul class="nav side-menu">
                            ...
                            <li><a><i class="fa fa-edit"></i> 상담신청 관리 <span class="fa fa-chevron-down"></span></a>
                                <!-- <ul class="nav child_menu">
                                    <li><a href="/lifenplus/admin/event/list"> 상담신청 내역</a></li>
                                </ul> -->
                            </li>
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li class="">
                            <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                                <!-- <?=$_SESSION['lifenplus_id']?> 님 -->
                            </a>
                            <ul class="dropdown-menu dropdown-usermenu pull-right">
                                <li><a href="/lifenplus/admin/main/logout"><i class="fa fa-sign-out pull-right"></i> Log Out</a></li>
                            </ul>
                        </li>
                    </ul>
                    </li>
