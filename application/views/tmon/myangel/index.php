...
<body>
	<div class="sect_1">
		<div class="container">
			<div class="col-sm-offset-3 col-sm-6 col-xs-12">
				<img src="/assets/images/tmon/myangel/main.png" alt="메인이미지">
			</div>
		</div>
	</div>
	<div class="sect_2">
			...
			<div class="col-sm-offset-3 col-sm-6 col-xs-12">
				<div class="video-bg add_bg_01">
					<div class="video-container">
						<iframe width="100%" src="https://www.youtube.com/embed/hAW3S8IL9QE" frameborder="0"></iframe>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="container">
			<div class="col-sm-offset-3 col-sm-6 col-xs-12">
				<div class="get_area_m" id="list" style="margin: 20px;">
					<button id="button" class="sbj_01" onclick="location.href='tel:080-507-3333'">
	...
	<div class="sect_3 mobile1">
		<div class="container">
			<div class="col-sm-offset-3 col-sm-6 col-xs-12">
				<div style="margin: 20px;">
					<button id="button" class="myangel" onclick="location.href='tel:080-507-3333'">
		...
		<div id="pop">
			<article>
				...
				<div class="infoDetail">
					...
					<p><strong>[ 080-507-3333 ]</strong>으로 지금바로 전화주세요.</p><br>
		...
		<footer>
			<div class="container">
				<div class="col-sm-offset-3 col-sm-6 col-xs-12">
					<img src="/assets/images/tmon/myangel/footer.png" alt="푸터이미지">
				</div>
			</div>
		</footer>
</body>
